...
<div class="main-container">
  ...
  <tr>
    <td class="table-plus"><div align="left"><strong>Candidate ID </strong></div></td>
  ...
  <tr>
    <td class="table-plus"><div align="left"><strong>Qualification</strong></div></td>
    <td>{{$row->educational_qualification }}</td>
    </tr>
    <tr>
        <td class="table-plus"><div align="left"><strong>Party</strong></div></td>
        <td>{{$row->party }}</td>
        </tr>
        <tr>
