                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('ViewAllVoterRecords.view', $row->id) }}">
                                            <i class="fa fa-eye" title="View All Candidates' Record"></i>
                                        </a>                                    
                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                <h4 class="padding-top-30 mb-30 weight-500">Are you sure you want to Disable This Voter ?
                </h4>
                <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
                    ...
                    <div class="col-6">
                        <a href="{{ route('enable_disable.Voter', $row->id) }}"><button button type="submit"
