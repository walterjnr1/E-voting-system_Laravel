...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img class="d-block w-66" src="carousel/1.jpg" alt="First slide">
			<div class="carousel-caption d-none d-md-block">
				<h5 class="color-white"></h5>
			</div>
		</div>
		<div class="carousel-item">
			<img class="d-block w-66" src="carousel/2.jpg" alt="Second slide">
			<div class="carousel-caption d-none d-md-block">
				<h5 class="color-white"></h5>
			</div>
		</div>
				...
				<div class="col-xl-3 mb-30">
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								<div class="h4 mb-0"><?php  
$countsparepart = DB::table('tblspare_parts')->count();
echo $countsparepart;   
?>
</div>
