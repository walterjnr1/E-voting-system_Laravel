...
<div class="main-container">
  ...
  <tr>
    ...
    <tr>
        <td class="table-plus"><div align="left"><strong>Candidate/Party</strong></div></td>
        <td>{{ $row->candidateName }}-{{ $row->party }}</td>
        </tr>
        <tr>
            <td class="table-plus"><div align="left"><strong>Date/Time</strong></div></td>
            <td>{{$row->vote_time }}</td>
            </tr>
