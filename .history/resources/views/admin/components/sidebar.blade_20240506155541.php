<div class="left-side-bar">
    <div class="brand-logo">
        <a href="{{ url('index') }}">
            <img src="{{ asset('uploadImage/Logo/logo.png') }}" alt="" class="dark-logo" width="88" height="44">
            <img src=" {{ asset('uploadImage/Logo/logo.png') }}" alt="" class="light-logo" width="88" height="44">
        </a>
