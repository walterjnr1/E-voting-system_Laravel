        ...
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="{{ route('add_user.view') }}">Add Admin</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="{{ route('candidatesRecordView.view') }}">Candidate Record</a></li>


                    </ul>
                </li>
                <li>
                    <a href="{{ route('votesRecordView.view') }}" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-edit"></span><span class="mtext">Votes</span>
                    </a>
                </li>
                 <li>
