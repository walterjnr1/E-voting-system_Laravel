...
class VoterController extends Controller
{
    ...
    public function registerVoter(voterRequest $request)
    {
        ...
        // Generate token for the newly registered voter
        $token = $voter->createToken($request->fullname.'registration')->plainTextToken;
    ...
    public function login(loginRequest $request)
    {
        ...
        $token = $voter->createToken($otp.'registration')->plainTextToken;
