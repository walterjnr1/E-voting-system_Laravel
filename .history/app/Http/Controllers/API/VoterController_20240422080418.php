...
$mail->send();
    ...
    $token = $voterRecord->createToken('Auth_login')->plainTextToken;
    return response()->json(['success' => true,'message' => 'OTP sent to your Email and Phone','token'=> $token,'data'=>$voter], 201);
    }
