...
class CandidateController extends Controller
{
    public function registerCandidate(Request $request)
    {
            ...
            $candidates = tblcandidate::where('voterID', $request->voterID)->first();
            $offices=$candidates->office;
            if ($candidates) {
                return response()->json(['success' => false, 'message' => 'You have already register as a {how to interopolate $offices in json message
