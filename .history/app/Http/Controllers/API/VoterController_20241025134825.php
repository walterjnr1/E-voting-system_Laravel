...
class VoterController extends Controller
{
    public function registerVoter(voterRequest $request)
    {
        ...
        $data = array('username' => env('SMS_USERNAME'), 'password' => env('SMS_PASSWORD'), 'sender' => env('SMS_SENDER_ID'), 'message' => $message, 'mobiles' => $voter->phone);
        ...
        //End of otp table
        return response()->json(['success' => true, 'message' => 'OTP sent to your Phone and Email', 'tok], 201);
    }
