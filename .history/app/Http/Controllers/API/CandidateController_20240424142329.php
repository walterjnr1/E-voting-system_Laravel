...
class CandidateController extends Controller
{
    public function registerCandidate(Request $request)
    {
        ...
        $request->validate([
            ...
            'fullname' => $request->voterID, 
            'phone' => "C".rand(10200, 90002),
            'email' => 0, 
            'state' => $request->office,
...
public function getCandidateDetails(Request $request)
{
    ...
    $candidateDetails = DB::table('tblcandidates')
        ->join('tblvoters', 'tblcandidates.voterID', '=', 'tblvoters.voterID')
        ->select('tblcandidates.*', 'tblvoters.email', 'tblvoters.fullname', 'tblvoters.educational_qualification')
