...
class VoterController extends Controller
{
    ...
    public function login(voterOTPRequest $request)
    {
        //$user_auth = Auth::user();
    ...
    public function validateLoginOTP(voterOTPRequest $request)
    {
        $otp = $request->otp;
    ...
    public function resendOtp(voterOTPRequest $request)
    {
        $voterID = $request->voterID;
        $voterRecord = tblvoter::where('voterID', $voterID)->first();
        ...
        //send otp email
        Mail::to($voterRecord->email)->send(new resendOtpMail($voterRecord->fullname));
    ...
    public function deleteAccount(voterOTPRequest $request)
    {
        $voterID = $request->voterID;
        $voterRecord = tblvoter::where('voterID', $voterID)->first();
        if (!$voterRecord) {
    ...
    public function getVoterDetails(voterOTPRequest $request)
    {
