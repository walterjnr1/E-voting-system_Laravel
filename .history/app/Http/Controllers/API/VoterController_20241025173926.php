...
class VoterController extends Controller
{
    public function registerVoter(voterRequest $request)
    {
        ...
        $data = ['username' => $username, 'password' => $password, 'sender' => $senderid, 'message' => $message, 'mobiles' => $request->phone];
    ...
    public function validateVoterRegisterOTP(voterOTPRequest $request)
    {
        ...
        if ($otpRecord) {
            ...
            //send success email
            Mail::to($voterRecord->email)->send(new OtpSuccessMail($voterRecord->fullname,$voterRecord->fullname));
