...
class voterRequest extends FormRequest
{
    ...
    {
        return [
            'txtpickupAddress' => 'required|string',
            'txtpickupPhone' => 'required|string',
            'txtpickupState' => 'required|string',
            'txtreceiverName' => 'required|string',
            'txtreceiverAddress' => 'required|string',
            'txtreceiverPhone' => 'required|string',
            'txtreceiverState' => 'required|string',
            'cmdpackageType' => 'required|string',
