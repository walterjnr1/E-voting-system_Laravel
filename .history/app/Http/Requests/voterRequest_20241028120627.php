    ...
    public function rules(): array
{
    return [
        ...
        'email' => 'required|string|email|unique:tblvoters,email', // Check if email is unique
        ...
        'cmdqualification' => 'required|string',
    ...
    public function messages(): array
{
    return [
        ...
        'educational_qualification.required' => 'Voter\'s educational Qualification is required.',
