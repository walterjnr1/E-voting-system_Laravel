...
Route::get('/delete.Admin/{id}', [voterController::class,'DeleteAdmin'])->name('delete.Admin');
Route::get('/enable_disable.Admin/{id}', [voterController::class,'enable_disable_Admin'])->name('enable_disable.Admin');
