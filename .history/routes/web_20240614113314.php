...
Route::get('/delete.Candidate/{id}', [voterController::class,'DeleteCandidate'])->name('delete.Candidate');
Route::get('/enable_disable.Candidate/{id}', [voterController::class,'enable_disable_Candidate'])->name('enable_disable.Candidate');
