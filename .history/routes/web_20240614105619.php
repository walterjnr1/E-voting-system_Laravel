...
Route::middleware('auth')->group(function () {
    Route::get('/ViewVotesData', [votesController::class,'votesRecordView'])->name('votesRecordView.view');
   });

Route::middleware('auth')->group(function () { Route::get('/ViewVotesData', [votesController::class,'votesRecordView'])->name('votesRecordView.view');
   });