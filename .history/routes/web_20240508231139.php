...
Route::get('/delete.Voter/{id}', [voterController::class,'DeleteAdmin'])->name('delete.Admin');
Route::get('/enable_disable.Voter/{id}', [voterController::class,'enable_disable_Admin'])->name('enable_disable.Admin');
