...
// candidate route
 ...
 Route::get('/getPresidentCandidateDetails', [CandidateController::class,'getPresidentCandidateDetails'])->name('getCandidateDetails.Get');
 Route::get('/getGovernorCandidateDetails', [CandidateController::class,'getCandidateDetails'])->name('getCandidateDetails.Get');
